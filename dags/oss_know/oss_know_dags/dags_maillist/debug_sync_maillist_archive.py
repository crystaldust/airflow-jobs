        ...
        [
            {
                ...
                "list_name": "busybox",
                "url_prefix": "http://lists.busybox.net/pipermail/busybox"
            },
            {
                "archive_type": "pipermail",
                "list_name": "uclibc",
                "url_prefix": "http://lists.busybox.net/pipermail/uclibc"
            }
        ],
...
for mail_list_info in mail_lists:
    project_name = mail_list_info['project_name']
    for mail_list_item in mail_list_info['mail_lists']:
        params = dict(mail_list_item.items() | {'project_name': project_name}.items())
