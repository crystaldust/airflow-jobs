...
from oss_know.libs.base_dict.variable_key import CLICKHOUSE_SYNC_INTERVAL, OPENSEARCH_SYNC_COMBINATION_TYPE, \
    SYNC_FROM_OPENSEARCH_CONN_INFO, OPENSEARCH_CONN_DATA, SYNC_OPENSEARCH_GITHUB_ISSUES_TIMELINE_INCLUDES
...
all_owner_repos = Variable.get(SYNC_OPENSEARCH_GITHUB_ISSUES_TIMELINE_INCLUDES, deserialize_json=True, default_var=None)
