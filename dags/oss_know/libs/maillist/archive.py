...
class OSSKnowMBoxEnrich(MBoxEnrich):
    ...
    def get_rich_item(self, item):
        ...
        eitem['File-Name'] = item['data']['File-Name']
...
def sync_archive(opensearch_conn_info, **maillist_params):
    ...
    file_name = path.splitext(path.basename(dirpath))[0]
    num_raw = _data2es(repo.fetch(), ocean_backend, project_name, list_name, file_name)
...
def _data2es(items, ocean, project_name, mail_list_name, file_name):
